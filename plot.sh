...
plot "Delta.dat" using 1:2 with lines lc 0 lw 2 dt '-.-' title 'Delta_{old} Re',\
    ...
    "Delta_new_minimized.dat" using 1:2 with lines lc 4 lw 2 dt '-.-' title 'Delta_{min} Re',\
    "Delta_new_minimized.dat" using 1:3 with lines lc 4 lw 2 title 'Delta_{min} Im'
unset yrange
